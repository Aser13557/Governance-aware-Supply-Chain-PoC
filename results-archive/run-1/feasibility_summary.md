# Track A — feasibility summary (generated 2026-08-19T05:56:12.174Z)
...
- **S2 (audit pack).** A regulator-facing audit pack for lot LOT-D
  ...
  generated in 394 ms; payload verification against the off-ledger
...
```
INVARIANT VIOLATION [totality]: no governance policy is active at submission time 2026-08-19T05:55:13Z; every accepted header must bind exactly one policy hash

INVARIANT VIOLATION [custody continuity]: Transfer of asset \

INVARIANT VIOLATION [recall lock]: asset \
```
