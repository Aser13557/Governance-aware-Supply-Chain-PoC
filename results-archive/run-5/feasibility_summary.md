# Track A - feasibility summary (generated 2026-08-26T22:34:59.237Z)
...
- **S2 (audit pack).** A regulator-facing audit pack for lot LOT-D containing
  ...
  reference, was generated in 422 ms; payload verification against the
...
- **S4 (validation surface).** 18 of 18 admission
...
```
INVARIANT VIOLATION [totality]: no governance policy is active at submission time 2026-08-26T22:33:27Z; every accepted header must bind exactly one policy hash
...
GOVERNANCE REJECTION [change control]: AnchorPolicy is restricted to the consortium-admin identity (Org1MSP); caller is Org2MSP

GOVERNANCE REJECTION [change control]: ClearRecall is restricted to the consortium-admin identity (Org1MSP); caller is Org2MSP

GOVERNANCE REJECTION [retroactivity]: effectiveFrom 2026-08-26T22:24:55Z precedes the anchoring time 2026-08-26T22:34:55Z; a policy version may not be declared in force before it was anchored

GOVERNANCE REJECTION [ordering]: effectiveFrom 2026-08-26T23:04:59Z must be strictly after existing version v3.0 (2026-08-26T23:34:55Z); policy supersession is prospective
```
