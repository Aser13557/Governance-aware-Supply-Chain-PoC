# Track A — feasibility summary (generated 2026-08-21T15:30:45.095Z)
...
- **S2 (audit pack).** A regulator-facing audit pack for lot LOT-D
  ...
  generated in 377 ms; payload verification against the off-ledger
...
```
INVARIANT VIOLATION [totality]: no governance policy is active at submission time 2026-08-21T15:29:46Z; every accepted header must bind exactly one policy hash
