...
| `[membership]` | submission by a suspended organization | model 3.5; architecture 5.B | `N-MEMBER-SUSPENDED.txt` | yes |
| `[change control]` | organization admitted by a non-authorised identity | model 3.5; architecture 5.B | `N-MEMBER-NONADMIN.txt` | yes |
| `[change control]` | dispute resolved by a non-authorised identity | model 3.5; architecture 5.C | `N-DISPUTE-NONADMIN.txt` | yes |
| `[emergency]` | submission inside a scope frozen by a time-bounded override | architecture 5.C | `N-EMERGENCY.txt` | yes |

22 of 22 checks demonstrated by a correctly tagged rejection.
