...
Raw peer output is archived beside each parsed message. Corresponds to dissertation §5.11 / Table 5.7 and, in the MBD 2026 submission, §V-D, which reports this scenario in prose and carries no per-check table.
